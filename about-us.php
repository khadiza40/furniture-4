...
<body class="commpn-here res layout-1">
	...
	<div id="wrapper" class="wrapper-fluid banner-effect-3">
		...
		<div class="breadcrumbs">
			<div class="container">
				<h1 class="category-name">ABOUT US</h1>
				<ul class="breadcrumb">
					<li>
		...
		<div class="about-us">
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-12">
							<img src="image/catalog/demo/about/about.png" alt="" class="img-responsive">
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12 about-desc-box">
							<h2 class="about-title">ABOUT<span> Furni<span>com</span></span></h2>
							...
							<h4 class="signature">Magentech.design</h4>
						</div>
					</div>
				</div>
			</div>
			<div class="about-our-team">
				<div class="container">
					<h3 class="our-team-title">OUR TEAM</h3>
					<div class="our-team-slider yt-content-slider" data-autoplay="yes" data-delay="4" data-speed="0.6" data-margin="30" data-items_column00="4" data-items_column0="4" data-items_column1="4" data-items_column2="3" data-items_column3="2" data-items_column4="1" data-arrows="yes" data-pagination="no" data-lazyload="yes" data-loop="yes" data-hoverpause="yes">
						<div class="item-slider">
							<div class="member-box">
								<a href="#" class="hv-radial">
									<img src="image/catalog/demo/about/ourmember01.png" alt="">
								</a>
								<h6 class="member-name"><a href="#" class="smooth" title="">Jennifer lawrence</a></h6>
								<p class="member-position">CEO</p>
								<p class="member-desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer condimentum </p>
							</div>
						</div>
						<div class="item-slider">
							<div class="member-box">
								<a href="#" class="hv-radial">
									<img src="image/catalog/demo/about/ourmember02.png" alt="">
								</a>
								<h6 class="member-name"><a href="#" class="smooth" title="">Jennifer lawrence</a></h6>
								<p class="member-position">Manage</p>
								<p class="member-desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer condimentum </p>
							</div>
						</div>
						<div class="item-slider">
							<div class="member-box">
								<a href="#" class="hv-radial">
									<img src="image/catalog/demo/about/ourmember03.png" alt="">
								</a>
								<h6 class="member-name"><a href="#" class="smooth" title="">Jennifer lawrence</a></h6>
								<p class="member-position">Sale & Marketing</p>
								<p class="member-desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer condimentum </p>
							</div>
						</div>
						<div class="item-slider">
							<div class="member-box">
								<a href="#" class="hv-radial">
									<img src="image/catalog/demo/about/ourmember04.png" alt="">
								</a>
								<h6 class="member-name"><a href="#" class="smooth" title="">Jennifer lawrence</a></h6>
								<p class="member-position">Deverlopment</p>
								<p class="member-desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer condimentum </p>
							</div>
						</div>
